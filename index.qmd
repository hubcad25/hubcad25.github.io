...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/qr_code.png?raw=true?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/logo_CLESSN.png?raw=true?raw=true){.absolute top=330 left=630 width="30%"}
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/yaduf.png?raw=true){.absolute top=200 left=0 width="35%"}
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/citizen.jpg?raw=true){.absolute top=470 left=470 width="10%"}
