...
format:
  revealjs:
    mermaid: 
       theme: dark
    theme: simple
    logo: https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/logo_CLESSN.png?raw=true
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/qr_code.png?raw=true?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/logo_CLESSN.png?raw=true?raw=true){.absolute top=330 left=630 width="30%"}
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/yaduf.png?raw=true){.absolute top=200 left=0 width="35%"}
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/science.png?raw=true){.absolute top=150 left=800 width="30%"}
:::
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/binoculars.png?raw=true){.absolute top=430 left=600 width="10%"} 

![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/citizen.jpg){.absolute top=470 left=470 width="10%"}
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/3_pred_rci_parties_position.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}


##

![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/clustering_results2.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="80%" style="z-index: -1.15; margin: auto auto;"}


## 
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/cluster3.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}

##
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/cluster4.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}


##
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/famille_classe_moyenne_elevee_white.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}

##
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/guns_by_county.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}

##

![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/ex/posterior_coefficients_artists.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}
...
:::{.column width="50%"}
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/sample-file-path_orig.png?raw=true){.absolute top=240 left=600 width="50%"}
...
│   └── plots/                  
│       └── data_distribution.png?raw=true  
├── docs/                
│   ├── methodology.md    
│   ├── references.bib    
...
![](https://github.com/hubcad25/hubcad25.github.io/blob/main/_SharedFolder_fss_introduction_r/img/qr_code.png?raw=true){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}